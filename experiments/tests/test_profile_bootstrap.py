...
def test_cold_start_uses_baseline_pdf_and_incremental_pdf_merge(test_db_path, monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("PAPERFLOW_BASELINE_PDF", baseline_pdf)
...
def test_parse_google_scholar_profile_paginates_and_aggregates_network_signals(monkeypatch):
    ...
    monkeypatch.setenv("PAPERFLOW_SCHOLAR_PAGE_SIZE", "20")
    monkeypatch.setenv("PAPERFLOW_SCHOLAR_PUBLICATION_LIMIT", "25")
    monkeypatch.setenv("PAPERFLOW_SCHOLAR_MAX_PAGES", "2")
