...
def settings() -> Dict[str, Any]:
    return {
        ...
        "database": str(db_ops.DB_PATH),
        "paths": {
            "pdf_dir": _configured_path("PAPERFLOW_PDF_DIR", "data/papers"),
            "reading_reports_dir": _configured_path("PAPERFLOW_READING_REPORTS_DIR", "data/reading_reports"),
            "wiki_dir": _configured_path("PAPERFLOW_WIKI_DIR", "data/wiki"),
            "monthly_report_dir": _configured_path("PAPERFLOW_MONTHLY_REPORT_DIR", "data/wiki/monthly_reports"),
            "topic_index_dir": _configured_path("PAPERFLOW_TOPIC_INDEX_DIR", "data/wiki/monthly_reports"),
            "monthly_subdir": _env_bool("PAPERFLOW_STORAGE_MONTHLY_SUBDIR", default=False),
